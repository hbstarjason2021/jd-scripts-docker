...
!(async () => {
    ...
    const author = Math.random() > 0.5 ? 'starjason' : 'starjason'
...
function getShareCode(name, author = 'starjason', num = -1, shuffle = false) {
    return new Promise(resolve => {
        $.get({
            url: `https://jihulab.com/hbstarjason/sharecode/-/raw/master/nnfls.json}`,
            headers: {
