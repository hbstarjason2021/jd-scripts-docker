...
async function signInit() {
  return new Promise(resolve => {
    $.get(taskUrl('speedSignInit', {
      ...
      "kernelPlatform": "RN",
      "inviterId":"/i6MFTclO6QmFj77KWv3mXzNKqCtS9QXIHxQr/Gb+KY="
    }), async (err, resp, data) => {
      try {
        if (err) {
