...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/tiger.json')
    }
    if (res) {
