...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/cfd.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/cfd.json');
    res2 = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/cfd.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/cfd.json');
