    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('starjason'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_709c349f13b51'), 1));
          fixPins.push(...run_pins.splice(run_pins.indexOf('yuxiachenqi'), 1));
