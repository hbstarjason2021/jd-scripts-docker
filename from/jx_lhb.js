...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  if (!res) {
    $.http.get({url: 'https://gitee.com/starjason/sharecode/raw/master/jxhb.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  }
  if (res && res.activeId) $.activeId = res.activeId;
  let res2 = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  }
