...
[task_local]
#京喜领88元红包
4 2,10 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_lhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "4 2,10 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="4 2,10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_lhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jx_lhb.js, cronexpr="4 2,10 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '助力逻辑：先自己京东账号相互助力，如有剩余助力机会，则助力作者\n' +
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  if (!res) {
    res = await getAuthorShareCode('https://gitee.com/starjason/sharecode/raw/master/jxhb.json')
  }
