...
main();
async function main() {
  $.http.get({url: `https://purge.jsdelivr.net/gh/shylocks/Loon/@main/jd_live_redrain2.js`}).then((resp) => {
...
function updateShareCodes(url = 'https://raw.githubusercontent.com/shylocks/Loon/main/jd_live_redrain2.js') {
...
function scriptsCDN(url = 'https://raw.fastgit.org/shylocks/Loon/main/jd_live_redrain2.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
