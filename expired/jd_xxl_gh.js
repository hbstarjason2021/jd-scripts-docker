...
main();
async function main() {
  $.http.get({url: `https://purge.jsdelivr.net/gh/shylocks/Loon/@main/jd_xxl_gh.js`}).then((resp) => {
...
function updateShareCodes(url = 'https://raw.githubusercontent.com/shylocks/Loon/main/jd_xxl_gh.js') {
...
function scriptsCDN(url = 'https://raw.fastgit.org/shylocks/Loon/main/jd_xxl_gh.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
