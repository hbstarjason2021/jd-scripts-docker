...
function updateShareCodes(url = 'https://raw.githubusercontent.com/shylocks/Loon/main/jd_mh_super.js') {
...
function scriptsCDN(url = 'https://raw.fastgit.org/shylocks/Loon/main/jd_mh_super.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
