...
// account  账号:密码
const pass = "xxxxx@gmail.com:passwd" 
totalList =[
    "https://niaoyun.me/,xxxxx@hotmail.com:passwd",
    `https://www.dabai.in/,${pass}`
    // `https://account.boostclouds.com/,${pass}`
    // `https://hyss.org/,${pass}`, // 不免费
    // `https://gs1024.com/,${pass}` // 光速云不能签到
]
