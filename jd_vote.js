...
function updateShareCodes(url = 'https://raw.githubusercontent.com/shylocks/Loon/main/jd_vote.js') {
...
function scriptsCDN(url = 'https://raw.fastgit.org/shylocks/Loon/main/jd_vote.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
